...
class SportsNewsBloc extends HydratedBloc<NewsEvent, NewsState> {
  final NewsRepository newsRepository;

  SportsNewsBloc({required this.newsRepository}) : super(NewsState.initial()) {
  ...
  Future _newsLoadStarted(
    ...
    try {
      News news = await newsRepository.getNews(category: NewsCategory.sports);

...
class TechnologyNewsBloc extends HydratedBloc<NewsEvent, NewsState> {
  final NewsRepository newsRepository;

  TechnologyNewsBloc({required this.newsRepository})
  ...
  Future _newsLoadStarted(
    ...
    try {
      News news =
          await newsRepository.getNews(category: NewsCategory.technology);
